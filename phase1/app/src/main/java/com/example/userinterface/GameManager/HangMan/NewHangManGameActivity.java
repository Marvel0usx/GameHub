...
public class NewHangManGameActivity extends Activity implements ScoreSystem {
    ...
    public void onBackPressed() {
        gameManager.reLocate(NewHangManGameActivity.this, 1, 0);
    }
    ...
    public void makeGuess(View v) {
        ...
        if (correct) {
            ...
            if (numCorr == currLen) {
                ...
                gameManager.toInter(NewHangManGameActivity.this,true);
                // the game ends since the user has won
                NewHangManGameActivity.this.finish();
            }
            ...
            if (remainingBallons == 0) {
                ...
                gameManager.getUser().addToCurrScore(getGameScore());
                gameManager.toInter(NewHangManGameActivity.this,false);
